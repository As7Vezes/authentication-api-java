package com.example.authenticationAPI.security.authentication;
...
import com.example.authenticationAPI.security.userdetails.UserDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                User user = userDetailsService.getSubscriptionType(subject);
